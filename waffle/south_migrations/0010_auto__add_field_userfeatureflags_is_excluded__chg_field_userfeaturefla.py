...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFeatureFlags.is_excluded'
        db.add_column(u'waffle_userfeatureflags', 'is_excluded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'UserFeatureFlags.is_active'
        db.alter_column(u'waffle_userfeatureflags', 'is_active', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):
        # Deleting field 'UserFeatureFlags.is_excluded'
        db.delete_column(u'waffle_userfeatureflags', 'is_excluded')


        # Changing field 'UserFeatureFlags.is_active'
        db.alter_column(u'waffle_userfeatureflags', 'is_active', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'waffle.userfeatureflags': {
            ...
            'is_excluded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
